...
export default function RegistrasiObatModal({ open, onClose, setRefetch, ...other }) {
    ...
    const NAMA_OBAT_OPTIONS =
        watch('jenisObat') === 'Vaksin' ?
            ...
            [
                ...
                { label: 'Flunixin (Anti-inflamasi non-steroid)', value: 'Flunixin (Anti-inflamasi non-steroid)' },
    ...
    const modalBody = (
        <Box sx={{ borderRadius: 1, p: 2, display: 'flex', flexDirection: 'column', gap: 2 }}>
            ...
            />
            <RHFTextField
                name="konsentrasiBahanAktif"
                label="Konsentrasi Bahan Aktif"
                type={'number'}
            />
            <RHFTextField
                name="merkObat"
            ...
            >
                ...
                <RHFTextField
                    name="intervalPengobatan"
                    label="Interval Pengobatan"
                    type={'number'}
                />
                <RHFSelect
            ...
            <RHFTextField
                name="peringatanKontradiksi"
                label="Peringatan Kontradiksi"
            />
            <RHFTextField
                name="fungsiSpesifik"
                label="Fungsi Spesifik"
            />
            <RHFDatePicker name="tanggalKadaluarsa" label="Tanggal Kadaluarsa" sx={{ width: "100%" }} disablePast />
            <RHFTextField
                name="batch"
                label="Batch"
            />

...
export default function NotificationsDokter() {
  ...
  useEffect(() => {
    getData(page, 10, 'name = "Laporan Surveilans Ternak"', '-created', 'notifications');
  }, [])
  ...
  const handleLoadMore = async () => {
    ...
    setPage((x) => x + 1);
    getData(page + 1, 10, 'name = "Laporan Surveilans Ternak"', '-created', 'notifications');
  ...
  return (
    <>
      ...
      >
        <Badge badgeContent={totalData > 9 ? '9+' : totalData} color="error">
      ...
      >
        ...
        >
          ...
          <IconButton
            onClick={() => {
              setNotif([]);
              getData(1, 10, 'name = "Laporan Surveilans Ternak"', '', 'notifications');
              setPage(1);
            }}
          >

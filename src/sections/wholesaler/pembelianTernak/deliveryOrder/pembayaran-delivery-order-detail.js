...
export default function PembayaranDeliveryOrderDetail({ deliveryOrder, handlePrint }) {
          ...
          <TableBody>
            {deliveryOrder?.items?.map((row, index) => (
              <TableRow key={index}>
                ...
                <TableCell align="center">{row.berat}</TableCell>
          ...
          >
            ...
            >
              ...
              <Stack flexDirection="row">
                ...
                >
                  {`: ${deliveryOrder?.pembelian?.lokasiTujuan}`}
                </Typography>
              </Stack>
            </Stack>
          ...
          >
            ...
            >
              ...
              <Stack flexDirection="row">
                ...
                <Typography variant="caption" fontSize={16} sx={{ width: '60%' }}>
                  {`: ${
                    deliveryOrder?.deliveryOrder?.noKendaraan
                  } / ${deliveryOrder?.deliveryOrder?.namaSupir.toUpperCase()}`}
                </Typography>
              </Stack>
            </Stack>
            ...
            <Stack spacing={1} ml={3} py={2.5} justifyContent="flex-start">
              <Stack flexDirection="row">
                ...
                <Typography variant="caption" fontSize={16} sx={{ width: '60%' }}>
                  {`: ${fDate(deliveryOrder?.createdAt).toUpperCase()}`}
                </Typography>
              </Stack>
            </Stack>
          </Box>
...
PembayaranDeliveryOrderDetail.propTypes = {

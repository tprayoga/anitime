...
export default function KanbanTaskItem({ task, index, onDeleteTask, onUpdateTask, sx, ...other }) {
  ...
  const renderData = (
    <Stack direction="row" alignItems="center" justifyContent="space-between">
      <Stack spacing={1}>
        <Typography variant="subtitle2">Tanggal Laporan</Typography>
        <Stack
          flexGrow={1}
          direction="row"
          alignItems="center"
        ...
        >
          ...
          <Box component="span">22/12/2023</Box>
        </Stack>
        <Box component="span" sx={{ mr: 1, typography: 'caption' }}>
          Gejala: Diare
        </Box>
      </Stack>
      ...
      >
        <Box
          component="img"
          alt="https://www.yiwubazaar.com/resources/assets/images/default-product.jpg"

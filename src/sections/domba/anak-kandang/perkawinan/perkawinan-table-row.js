...
export default function PerkawinanTableRow({ row, selected, openModal, setSelectedData, setType }) {
  const {
    id,
    namaKandang,
    luasKandang,
    ...
    <>
      <TableRow hover selected={selected}>
        <TableCell
          ...
          onClick={() => {
            router.push(`${paths.dombaAnakKandang.kandang.detail(id)}`);
          }}
        >
          {fDate(created)}
        </TableCell>
        <TableCell sx={{ typography: 'caption' }}></TableCell>
        <TableCell sx={{ typography: 'caption' }}></TableCell>
        <TableCell sx={{ typography: 'caption' }}>{metodePengkawinan} Ekor</TableCell>
        {/* <TableCell sx={{ typography: 'caption' }}>{deskripsi}</TableCell> */}

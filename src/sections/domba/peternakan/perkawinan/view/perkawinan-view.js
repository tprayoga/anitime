        ...
        <Typography
          ...
          onClick={() => {
            user.role === 'peternakan'
              ? window.open(`${paths.dombaPeternakan.perkawinan.detail(params?.row?.id)}`, '_blank')
              : window.open(
                  `${paths.dombaIntiPeternakan.perkawinan.detail(params?.row?.id)}`,
                  '_blank'
                );
          }}
        >
  ...
  const columnsBirahi = [
    {
      ...
      renderCell: (params) => (
        <Typography
          ...
          onClick={() => {
            user.role === 'peternakan'
              ? window.open(`${paths.dombaPeternakan.birahi.detail(params?.row?.ternak)}`, '_blank')
              : window.open(
                  `${paths.dombaIntiPeternakan.birahi.detail(params?.row?.ternak)}`,
                  '_blank'
                );
          }}
        >
